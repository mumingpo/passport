 ...
 *   - `failWithError`    True to fail with a javascript error as opposed to respond to the request.
 *   - `errorMessage`     String to set the error.message to in case of authentication error.
  ...
  return function authenticate(req, res, next) {
    ...
    function allFailed() {
      ...
      if (options.failWithError) {
        return next(new AuthenticationError(options.errorMessage || http.STATUS_CODES[res.statusCode], rstatus));
      }
